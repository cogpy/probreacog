...
#
get_filename_component(filename "/home/runner/work/probreacog/probreacog/_codeql_build_dir/external/tmp-capd/download/capd-capdDynSys-5.1.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/probreacog/probreacog/_codeql_build_dir/external/tmp-capd/src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-capd${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-capd${i}")
